...
\end{tcolorbox}
    ...
    \todo{Show in graph that partial derivative is undefined in case of perfect hedge and that this is why Euler allocation is failing. Central difference happens to remedy this effect.}
