...
individually, while the \gls{ISDA SIMM} \gls{IM} model evaluates the IRS to be 61\%
riskier.
...
portfolios. This is not surprising since both, the \gls{SA-CCR} and \gls{ISDA SIMM}
