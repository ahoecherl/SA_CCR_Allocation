...
\prompt{Out}{outcolor}{Out}{\boxspacing}    
    \begin{center}
    \adjustimage{max size={0.9\linewidth}{0.9\paperheight}}{JupyterNotebooksFull/output_14_0.jpg}
    \end{center}
    { \hspace*{\fill} \\}
\end{tcolorbox}
...
\prompt{Out}{outcolor}{Out}{\boxspacing}    
    \begin{center}
    \adjustimage{max size={0.9\linewidth}{0.9\paperheight}}{JupyterNotebooksFull/output_16_0.jpg}
    \end{center}
    { \hspace*{\fill} \\}
\end{tcolorbox}
