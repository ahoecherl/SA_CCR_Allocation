...
\subfile{sections/ISDA-SIMM_and_Sensitivities.tex}
\subfile{sections/SA_CCR}
...
\subfile{sections/conclusion_and_outlook}
...
\input{JupyterNotebooksFull/building_SA_CCR_Core.tex}
...
\input{JupyterNotebooksFull/building_SA_CCR_2_Core.tex}

\input{JupyterNotebooksFull/issue_regulatory_swaption_delta_Core.tex}
...
\input{JupyterNotebooksFull/issue_regulatory_swaption_delta_2_Core.tex}

\input{JupyterNotebooksFull/building_SA_CCR_risk_horizon_Core.tex}

\input{JupyterNotebooksFull/SA_CCR_ird_addon_Core.tex}
...
\input{JupyterNotebooksFull/ExampleJupyterToLatex_Core.tex}
