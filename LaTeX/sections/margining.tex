...
\begin{description}
    ...
    Variation margin thresholds are banned by the regulator for any portfolio for which bilateral initial margin needs to be exchanged. \todo{Refer to regulation on this} 
    ...
    The regulator allows an IM threshold of up to 50Mn USD or EUR \todo{Reference corresponding legislation} which is quite a considerable amount in comparison to the calculated IM of average derivative portfolios \cite{ISDAMarginSurvey}.
