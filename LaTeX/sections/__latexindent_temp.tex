...
The \gls{SA-CCR} was implemented for the analysis section of this thesis but will not be presented in a comprehensive fashion here. Instead the reader may refer to the latest regulatory documents \todo{CRD2 document} and \todo{latest EBA update} or the library developed for this thesis \cite{Hoecherl2020}.
