...
\begin{document}
    ...
    For a detailed specification of the aggregation the reader may refer to \todo{insert again BIS and CRD definition of standardized approach}. The implementation of this approach is addressed in \ref{sec:ISDA SIMM implementation}.
