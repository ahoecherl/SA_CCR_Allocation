...
\begin{gather*}
    ...
    \begin{align}
        ...
        \frac{\partial \rho(\mathbf{u})}{\partial u_i} &= \frac{\rho(\mathbf{u}+\mathbf{h})-\rho(\mathbf{u})}{\epsilon} + \mathcal{O}(\epsilon) &\text{(forward difference)} \label{eq:forward difference}\\
