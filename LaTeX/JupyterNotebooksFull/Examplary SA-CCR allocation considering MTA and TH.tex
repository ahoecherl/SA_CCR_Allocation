\documentclass[11pt]{article}
    ...
    % Document parameters
    % Document title
    \title{Examplary SA-CCR allocation considering MTA and TH}
...
\begin{document}
    ...
    \hypertarget{examplary-sa-ccr-allocation-considering-th-and-mta}{%
\subsection{Examplary SA-CCR allocation considering TH and
MTA}\label{examplary-sa-ccr-allocation-considering-th-and-mta}}
