...
class SwaptionVolatilityQuotes(Enum):
    USD = SwaptionVolatilitySurface(optionTenors, swapTenors,
                                    ...
                                    [ql.SimpleQuote(1.139743663), ql.SimpleQuote(1.030655798),
                                      ql.SimpleQuote(0.900676861), ql.SimpleQuote(0.862388515),
                                      ql.SimpleQuote(0.811886583), ql.SimpleQuote(0.796711329),
                                      ql.SimpleQuote(0.808801882)],
                                    ])
    ...
    EUR = SwaptionVolatilitySurface(optionTenors, swapTenors,
                                    ...
                                    [ql.SimpleQuote(0.004827405), ql.SimpleQuote(0.005106651),
                                      ql.SimpleQuote(0.005877155), ql.SimpleQuote(0.006649729),
                                      ql.SimpleQuote(0.006698853), ql.SimpleQuote(0.006737146),
                                      ql.SimpleQuote(0.006789876)]
                                    ])
