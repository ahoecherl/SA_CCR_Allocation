...
def test_SwapPrice():
    ...
    ttstart = 5/365
    ttend = 10
    swap = InterestRateSwap(swapDirection=SwapDirection.PAYER, notional=notional, currency=currency, timeToSwapStart = ttstart, timeToSwapEnd = ttend, fixed_rate = fixed_rate, float_spread = float_spread)
    asdf = 1
